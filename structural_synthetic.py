from synthopt.process.structural_metadata import process_structural_metadata_sql
from synthopt.generate.structural_synthetic_data import generate_structural_synthetic_data_from_sql
...
rows = get_table_admisions(adapter, limit=1000)

# Get column names from the cursor description
cursor = adapter.get_cursor()
cursor.execute("SELECT * FROM iceberg.pedw.pedw_admissions_20231127 LIMIT 1000")
...
STRUCT_SYNTHETIC_DATA = generate_structural_synthetic_data_from_sql(STRUCT_METADATA,
